...
const getRoleFromRoleName = (role: number): Role | undefined => {
...
//el uso de [] en userrole es para apuntar a la clave de ese objeto, que es un array de objs
console.log(getRoleFromRoleName(""0""))
